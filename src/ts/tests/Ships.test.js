...
let horizontalShip, verticalShip, middleShip;
beforeEach(() => {
    horizontalShip = new Ship_1.default(1, 3);
    verticalShip = new Ship_1.default(3, 33);
    middleShip = new Ship_1.default(45, 65);
});
